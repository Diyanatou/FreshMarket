...
<nav class="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-5 gap-4 md:gap-0">
    <div class="flex items-center gap-3">
        <div class="bg-red-500 text-white w-12 h-12 flex items-center justify-center rounded-lg font-bold">Logo</div>
...
<section class="relative grid grid-cols-1 md:grid-cols-2 px-6 md:px-12 pt-10 pb-16 gap-8 md:gap-0">
    ...
    <div class="flex flex-col justify-center z-10">
        ...
        <h1 class="text-4xl md:text-5xl font-bold leading-tight mt-2">
            ...
            <span class="text-red-600 drop-shadow-lg">Livrées Rapidement</span>
        </h1>
...
<section class="max-w-6xl mx-auto py-16 px-6">
    <div class="text-center mb-12">
        <h2 class="text-3xl md:text-4xl font-bold text-red-600 mb-3">Notre Blog</h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <a href="#" class="text-red-500 font-semibold hover:underline">Lire la suite →</a>
            </div>
        </div>
        <!-- ARTICLE 2 -->
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
...
<section class="max-w-6xl mx-auto py-16 px-6">
    <div class="text-center mb-12">
        <h2 class="text-3xl md:text-4xl font-bold text-red-600 mb-3">Contactez-nous</h2>
        <div class="w-24 h-1 bg-red-500 mx-auto rounded-full mb-4"></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
        ...
        <div class="bg-white shadow-lg rounded-xl p-6 md:p-8">
            ...
            <form action="#" method="POST" class="flex flex-col gap-4">
                ...
                <button type="submit" class="bg-red-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-red-600 transition">Envoyer</button>
            </form>
        </div>
        ...
        <div class="flex flex-col gap-6">
            <div class="bg-white shadow-lg rounded-xl p-6 md:p-8">
                <h3 class="text-2xl md:text-3xl font-bold mb-3 text-red-600">Pourquoi nous choisir</h3>
            ...
            <div class="bg-white shadow-lg rounded-xl p-6 md:p-8">
                <h3 class="text-2xl md:text-3xl font-bold mb-3 text-red-600">Nos horaires</h3>
...
<!-- FOOTER -->
<footer class="bg-red-500 text-white py-12 mt-16">
    ...
    <div class="mt-12 border-t border-red-400 pt-6 text-center text-gray-100 text-sm md:text-base">
